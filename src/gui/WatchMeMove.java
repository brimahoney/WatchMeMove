...
public class WatchMeMove extends Application
{
    private static final int KEYBOARD_MOVEMENT_DELTA = 5;
    private static final Duration TRANSLATE_DURATION = Duration.seconds(0.50);
    ...
    public void start(Stage stage) throws Exception
    {
        ...
        circle.translateXProperty().addListener(new ChangeListener()
        {
            @Override
            public void changed(ObservableValue o, Object oldVal, Object newVal)
            {
                System.out.println("Circle moved! - centerX is now " + newVal);
                System.out.println("Circle centerX: " + circle.getCenterX());
                System.out.println("Transition toX: " + transition.getToX());
            }
        });
    ...
    {
        final Circle circle = new Circle(200, 150, 25, Color.BLUEVIOLET);
